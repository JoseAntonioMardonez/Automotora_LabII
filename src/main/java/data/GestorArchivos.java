...
public class GestorArchivos {
    ...
    public static Automotora leerArchivoUsuarios(Automotora automotora, String direccionArchivo) {
        String textoArchivo = "";
        try {
            ...
            while ((textoArchivo = br.readLine()) != null) {
                ...
                for(Cliente cliente : automotora.getClientes()){
                    automotora.getClientes().add(new Cliente(data[0], data[1], Integer.parseInt(data[2]), data[3], data[4]));
                }
            }
            br.close();
            fr.close();
